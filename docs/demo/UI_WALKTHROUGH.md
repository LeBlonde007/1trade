# 1Trade — UI Walkthrough (the 31 screens we actually have)
...
| `/compute` · `/compute/new` · `/compute/[id]` | GPU instances: list, create (type/count), instance detail | `1trade gpu create` → running box; on-demand + reserved |
