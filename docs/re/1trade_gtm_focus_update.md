# 1Trade — GTM Focus & Sequencing Update
...
With trading paused, 1Trade competes more directly as a neocloud — so the platform-phase edge has
...
investor narrative as the second act — it's what makes 1Trade more than "another neocloud."
