# Exascale — Settlement & Trust Architecture
...
- **v1 backing = Exascale's own datacenter.** You control the hardware, so attestation and telemetry are trivial to stand up and fully trusted. You bootstrap the market against capacity you can prove cold.
