# 1Trade — Pitch Deck + Demo Video Script
...
>
> Both lean on the personas in `1trade_persona_demo_flows.md` and the
...
| **SOM** Volume routed through 1Trade in Y5 | — | **$5B** (0.5% of TAM) |
...
- **24 / 26 MVP screens shipped** (per `1trade_mvp_screens_checklist.md`).
- **3 personas fully covered** — Trader, Enterprise Buyer, Datacenter
  Partner — with end-to-end demo flows in `1trade_persona_demo_flows.md`.
...
- **30+ post-MVP screens designed and catalogued** in
  `1trade_v15_screens_prompts.md` — investors can see the v1.5 roadmap.
- **Backend / integration spec** documented in
  `1trade_integration_primer.md` — agent install via mTLS WSS,
...
`1trade.com · contact@1trade.com · 2026`
...
1trade.com · raising $5M seed
```

**VO (1:30):** *"1Trade. The commodity market for AI compute."*
