...
function providerLabel(ownedBy: string): string {
  return !ownedBy || ownedBy.toLowerCase() === '1trade' ? 'Self-hosted' : ownedBy
}
...
onMounted(async () => {
  ...
  try {
    ...
    for (const m of list) map[m.id] = { price: Number(m.trade1.price), creditType: m.trade1.credit_type, unit: m.trade1.unit }
...
client = OpenAI(
    base_url="https://api.trade1.com/v1",
...
print("usage:", resp.usage)`,
    ...
    curl: `curl https://api.trade1.com/v1/chat/completions \\
...
const client = new OpenAI({
  baseURL: "https://api.trade1.com/v1",
  apiKey:  process.env.TRADE1_API_KEY,  // esx_prod_a47b9c…
});
          ...
          <div class="pg-main">
            ...
            <template v-if="view === 'chat'">
              ...
              <div v-else class="api-only">
                ...
                <button type="button" class="api-only-copy" @click="copyText('1trade infer ' + selected.id, 'api-' + selected.id)">
            ...
            <template v-else>
              <div class="code-pane">
                ...
                <div class="code-foot">
                  <span class="mono dim">
                    base URL <code>https://api.trade1.com/v1</code> · auth via Bearer key from
