...
const instance = computed<Instance>(() => ({
  ...
  image: '1trade/cuda12.4-pytorch2.4-ubuntu22.04 (build #4218)',
  diskGB: 4096,
  ramGB: 1536,
  vcpu: 192,
  ipv4: '198.51.100.42',
...
const events = ref<Event[]>([
  ...
  { ts: '2026-05-22 08:13:41 UTC', type: 'provisioning',  level: 'info',    body: 'Image 1trade/cuda12.4-pytorch2.4-ubuntu22.04 pulled (4.2 GiB, 31s)',                              actor: 'system' },
          ...
          <ul class="cfg-grid">
            ...
            <li>
              ...
              <span class="mono ssh-line">
                ssh -i ~/.ssh/1trade_ed25519 {{ instance.sshUser }}@{{ instance.ipv4 }}
                <button class="copy-btn" @click="copyText(`ssh -i ~/.ssh/1trade_ed25519 ${instance.sshUser}@${instance.ipv4}`)"><Copy :size="11" :stroke-width="1.7" /></button>
              </span>
            </li>
            <li>
