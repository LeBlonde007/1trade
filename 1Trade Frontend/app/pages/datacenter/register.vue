...
const projected1TradeFee = computed(() =>
  ...
  <div v-if="!datacenterSignupLive" class="reg-shell soon-shell" data-theme="light">
    ...
    <main class="soon-main">
      <div class="soon-card">
        ...
        <p class="soon-contact">Want to supply GPUs early? <a href="mailto:partners@1trade.ai">partners@1trade.ai</a></p>
  ...
  <div v-else class="reg-shell" data-theme="light">
    ...
    <main class="page">
        ...
        <div class="section-body">
          <div class="summary-card">
            ...
            <div class="sc-row">
              ...
              <span class="sc-v">{{ fmtUsd(projected1TradeFee) }}</span>
            </div>
            <div class="sc-foot">
      ...
      <footer class="page-foot">
        ...
        <span class="pf-v mono-inline">ONB-7A3C91 · operator: ops@1trade.com · v2.4.1</span>
      </footer>
    </main>
  </div>
</template>
